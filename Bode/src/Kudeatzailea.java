...
public class Kudeatzailea {
	...
	public void Factura () {
		...
		System.out.println("Idatzi faktura zenbakia");
		...
		fact.setIzena(Izena);
		System.out.println("Idatzi bezeroaren abizena");
		...
		String [] dat;
		do {
			System.out.println("Idatzi artikulu kodigoa, kantitatea eta eman ENTER (adibides: FRES01-9),"
					+ "produktuak sartzen amaitzeko idatzi END");
			art=input.nextLine();
